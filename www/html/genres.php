...
<ul class="topnav">
  ...
  <li><a class="active" href="genres.php">Géneros</a></li>
...
<h1>Géneros</h1>
  ...
  <table width="50%" border="0" align="center">
    ...
    <tr>
      ...
      <td> <?php echo $genre->get('genres')->name; ?> </td>
 
      <td class="button"><a href="php/deleteGenre.php?Id=<?php echo $genre->get('genres')->name; ?>"><input type="image" src="img/trash.png" width="25" height="25" name="delete" id="delete" value="Borrar"></a></td>

      <td class="button"><a href="php/updateGenre.php?name=<?php echo $genre->get('genres')->name; ?>"><input type="image" src="img/update.png"  width="25" height="25" name="update" id="update" value="Actualizar"></a></td>
    </tr>    
