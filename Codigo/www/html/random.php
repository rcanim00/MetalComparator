...
<?php
  ...
  try{
	...
	$albums=$client->run(
	    'MATCH (albums:Album) RETURN count(albums) AS total'
	);

	$aleat=rand(0,$albums[0]->get('total')-1);
...
<ul class="topnav">
  ...
  <li><a class="active" href="random.php">Aleatorio</a></li>
  ...
  <li class="right"><a href="php/close.php">Cerrar sesión</a></li>
    ...
    <table width="50%" border="0" align="center">
      ...
      <tr>
        <td colspan="10" class="tableHeader"> Disco </td>
